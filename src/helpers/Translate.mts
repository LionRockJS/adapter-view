...
export default class Translate{
  ...
  static update(){
    ...
    "foo.name" => "foo"
   */
    if(!Central.config.liquidjs || !Central.config.liquidjs.translates) return;
  ...
  static setKey(key: string, value: any, language: string='en'){
  ...
  static t(key: string, language: string='en'){
